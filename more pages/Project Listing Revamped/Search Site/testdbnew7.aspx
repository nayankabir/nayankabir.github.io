...
<form id="form1" runat="server">
	<asp:AccessDataSource id="AccessDataSource1" runat="server" DataFile="G:\Google Drive\OneDrive Transfer\Canadian Tire Work Folder\00 IA Datamaster\Financial Analytics Pilot\Project Listing Dump 09-19-20161.mdb" SelectCommand="SELECT * FROM [Master Project Listing] WHERE ([PV Code (In IA)] LIKE '%' + ? + '%')">
		<SelectParameters>
			<asp:ControlParameter ControlID="PVCodeBox" Name="column1" PropertyName="Text" Type="String" />
		</SelectParameters>
	</asp:AccessDataSource>
	<p>
	<asp:Label id="Label1" runat="server" BorderStyle="Ridge" Text="Project Code"></asp:Label>
	&nbsp;&nbsp;
	<asp:TextBox id="PVCodeBox" runat="server"></asp:TextBox>
	&nbsp;&nbsp;&nbsp;
	...
	<p>
	<asp:GridView id="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSourcetest">
		<Columns>
	...
	<asp:SqlDataSource ID="SqlDataSourcetest" runat="server" ConnectionString="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString %>" ProviderName="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Master Project Listing] WHERE ([IT Delivery AVP] LIKE '%' + ? + '%')">
		<SelectParameters>
			<asp:ControlParameter ControlID="MPLSearchBoxAVP" Name="IT_Delivery_AVP" PropertyName="Text" Type="String" />
		</SelectParameters>
	</asp:SqlDataSource>
	<asp:SqlDataSource ID="SqlDataSource0920" runat="server" ConnectionString="<%$ ConnectionStrings:Project Listing Dump 09-19-2016ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:Project Listing Dump 09-19-2016ConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [Master Project Listing]">
	</asp:SqlDataSource>
	</p>
	<p>&nbsp;</p>
</form>
