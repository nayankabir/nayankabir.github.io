...
AND (([Forecast (BOY)]&gt;=?) OR ([Forecast (BOY)] IS NULL))">
		<SelectParameters>
			...
			<asp:ControlParameter ControlID="MPLSearchBoxActuals" DefaultValue="99999999999" Name="Actuals_(YTD)_" PropertyName="Text" />
			<asp:ControlParameter ControlID="MPLSearchBoxForecast" DefaultValue="0" Name="Forecast_(BOY)_" PropertyName="Text" />
		</SelectParameters>
