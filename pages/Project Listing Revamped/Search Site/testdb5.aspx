...
<form id="form1" runat="server">
	<asp:AccessDataSource id="AccessDataSource1" runat="server" DataFile="Project Listing Dump 09-19-2016.mdb" SelectCommand="SELECT * FROM [Master Project Listing] 
...
AND (([Forecast (BOY)]&gt;=?))">
		<SelectParameters>
			...
			<asp:ControlParameter ControlID="MPLSearchBoxActuals" DefaultValue="9999999999" Name="Actuals_(YTD)_" PropertyName="Text" Type="Decimal" />
			<asp:ControlParameter ControlID="MPLSearchBoxForecast" DefaultValue="0" Name="Forecast_(BOY)_" PropertyName="Text" Type="Decimal" />
		</SelectParameters>
	...
	<br />
&nbsp;&nbsp;&nbsp;
	<asp:ListBox id="ListBox1" runat="server" DataSourceID="SqlDataSource1test" DataTextField="Portfolio" DataValueField="Portfolio">
	</asp:ListBox>
	<asp:SqlDataSource ID="SqlDataSource1test" runat="server" ConnectionString="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString2.ProviderName %>" SelectCommand="SELECT DISTINCT [Portfolio] FROM [Master Project Listing] ORDER BY [Portfolio]">
	</asp:SqlDataSource>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<br />
&nbsp;<asp:GridView id="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="#F0F0F0" DataSourceID="SqlDataSource0920" DataKeyNames="ID">
...
<SortedDescendingHeaderStyle BackColor="#4870BE"></SortedDescendingHeaderStyle>
	...
	<asp:SqlDataSource ID="SqlDataSource0920" runat="server" ConnectionString="<%$ ConnectionStrings:Project Listing Dump 09-19-2016ConnectionString %>" ProviderName="<%$ ConnectionStrings:Project Listing Dump 09-19-2016ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Master Project Listing] 
WHERE (([PV Code (In IA)] LIKE '%' + ? + '%') OR ([PV Code (In IA)] IS NULL)) 
AND (([IT Delivery AVP ] LIKE '%' + ? + '%') OR ([IT Delivery AVP] IS NULL)) 
AND (([IT Delivery VP] LIKE '%' + ? + '%') OR ([IT Delivery VP] IS NULL)) 
AND (([Actuals (YTD)]&lt;=?))
AND (([Forecast (BOY)]&gt;=?))">
		<SelectParameters>
			<asp:ControlParameter ControlID="MPLSearchBox" ConvertEmptyStringToNull="False" Name="PV Code" PropertyName="Text" />
			<asp:ControlParameter ControlID="MPLSearchBoxAVP" ConvertEmptyStringToNull="False" Name="AVP" PropertyName="Text" />
			<asp:ControlParameter ControlID="MPLSearchBoxVP" ConvertEmptyStringToNull="False" Name="VP" PropertyName="Text" />
			<asp:ControlParameter ControlID="MPLSearchBoxActuals" DefaultValue="99999999999" Name="Actuals" PropertyName="Text" Type="Decimal" />
			<asp:ControlParameter ControlID="MPLSearchBoxForecast" DefaultValue="0" Name="Forecast" PropertyName="Text" Type="Decimal" />
		</SelectParameters>
	</asp:SqlDataSource>
</form>
