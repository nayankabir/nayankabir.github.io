...
AND (([Forecast (BOY)]&gt;=?))">
	...
	<br />
&nbsp;&nbsp;&nbsp;
	<asp:ListBox id="ListBox1" runat="server" DataSourceID="SqlDataSource1" DataTextField="PIMC_Exec" DataValueField="PIMC_Exec">
	</asp:ListBox>
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString3 %>" ProviderName="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString3.ProviderName %>" SelectCommand="SELECT DISTINCT [PIMC Exec] AS PIMC_Exec FROM [Master Project Listing]">
	</asp:SqlDataSource>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<br />
...
<SortedDescendingHeaderStyle BackColor="#4870BE"></SortedDescendingHeaderStyle>
	...
	<asp:SqlDataSource ID="SqlDataSource0920" runat="server" ConnectionString="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString3 %>" ProviderName="<%$ ConnectionStrings:Project Listing Dump 09-19-20161ConnectionString3.ProviderName %>" SelectCommand="SELECT * FROM [Master Project Listing] 
WHERE (([PV Code (In IA)] LIKE '%' + ? + '%') OR ([PV Code (In IA)] IS NULL)) 
AND (([IT Delivery AVP ] LIKE '%' + ? + '%') OR ([IT Delivery AVP] IS NULL)) 
AND (([IT Delivery VP] LIKE '%' + ? + '%') OR ([IT Delivery VP] IS NULL)) 
AND (([Actuals (YTD)]&lt;=?))
